...
import { deputyDecision, emergencyDecision, gateLogs, listLeaves, principalDecision } from '../controllers/authorityController.js';
...
router.post('/emergency/decision', authenticate, authorize('DEPUTY_WARDEN'), emergencyDecision);
